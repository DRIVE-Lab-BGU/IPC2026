...
International Planning Competition (IPC) 2026:
...
As part of the International Conference on Planning and Scheduling (ICAPS) 2026 in Dublin, we will be hosting a novel Planning and Reinforcement Learning (RL) track.  Key features and goals of the competition include:
